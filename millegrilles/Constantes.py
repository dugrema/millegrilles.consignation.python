...
CONFIG_MONGO_SSL = 'mongo_tls'
CONFIG_MONGO_SSL_CAFILE = 'mongo_tls_ca_certs'
CONFIG_MONGO_SSL_CERTFILE = 'mongo_tls_certfile'
CONFIG_MONGO_SSL_KEYFILE = 'mongo_tls_keyfile'
...
TRANSACTION_MESSAGE_LIBELLE_ACTION = 'action'
TRANSACTION_MESSAGE_LIBELLE_PARTITION = 'partition'
...
class ConstantesSecurityPki:
    ...
    LIBELLE_FINGERPRINT_CLE_PUBLIQUE ='fingerprint_pk'
...
class ConstantesGrosFichiers:
    ...
    LIBVAL_UUID_COLLECTION_SITES = 'sites'
    ...
    CHAMP_DATE_INDEXATION = 'dateIndexation'
...
class ConstantesGenerateurCertificat:
    ...
    ROLE_MAITRE_COMPTES = 'maitrecomptes'
    ROLE_COUPDOEIL = 'coupdoeil'
    ROLE_AGENT_BACKUP = 'agent_backup'
    ROLE_NGINX = 'nginx'
    ...
    ROLE_SENSEURSPASSIFS_HUB = 'senseurspassifs_hub'
    ROLE_MEDIA = 'media'
...
class ConstantesServiceMonitor:
    ...
    MODULE_MAITRECOMPTES = 'maitrecomptes_web'
    # MODULE_CEDULEUR = 'ceduleur'
    MODULE_CERTISSUER = 'certissuer'
    ...
    COMMANDE_RENOUVELLER_INTERMEDIAIRE = 'renouvellerIntermediaire'
...
class ConstantesForum:

    DOMAINE_NOM = 'Forum'
    COLLECTION_TRANSACTIONS_NOM = DOMAINE_NOM
    COLLECTION_FORUMS_NOM = '%s/forums' % COLLECTION_TRANSACTIONS_NOM
    ...
    TRANSACTION_AJOUTER_POST = 'ajouterPost'
    TRANSACTION_MODIFIER_POST = 'modifierPost'
    TRANSACTION_AJOUTER_COMMENTAIRE = 'ajouterCommentairePost'
    ...
    CHAMP_MEDIA_FUUID_MEDIA = 'fuuidMedia'
    CHAMP_MEDIA_MIMETYPE_MEDIA = 'mimetypeMedia'
    CHAMP_DATE_CREATION = 'dateCreation'
    CHAMP_DATE_MODIFICATION = 'dateModification'
