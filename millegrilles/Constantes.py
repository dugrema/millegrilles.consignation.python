...
class ConstantesPrincipale:
    ...
    TRANSACTION_CLE_NOM = 'nom'
    TRANSACTION_CLE_PRENOM = 'prenom'
    TRANSACTION_CLE_COURRIEL = 'courriel'
    TRANSACTION_CLE_TWITTER = 'twitter'
    TRANSACTION_CLE_FACEBOOK = 'facebook'
    TRANSACTION_CLE_NOM_MILLEGRILLE = 'nomMilleGrille'
    TRANSACTION_CLE_NOM_MILLEGRILLE_PAR_LANGUE = 'nomMilleGrilleParLangue'
    TRANSACTION_CLE_LANGUE_PRINCIPALE = 'langue'
    TRANSACTION_CLE_LANGUE_MULTILINGUE = 'multilingue'
    TRANSACTION_CLE_LANGUES_ADDITIONNELLES = 'languesAdditionnelles'
    ...
    DOCUMENT_PROFIL_USAGER = {
        ...
        TRANSACTION_CLE_COURRIEL: None,
        TRANSACTION_CLE_PRENOM: None,
        TRANSACTION_CLE_NOM: None,
        TRANSACTION_CLE_TWITTER: None,
        TRANSACTION_CLE_FACEBOOK: None,
    }

    DOCUMENT_PROFIL_MILLEGRILLE = {
        DOCUMENT_INFODOC_LIBELLE: LIBVAL_PROFIL_MILLEGRILLE,
        TRANSACTION_CLE_NOM_MILLEGRILLE: 'Sans nom',
        TRANSACTION_CLE_NOM_MILLEGRILLE_PAR_LANGUE: None,
        TRANSACTION_CLE_LANGUE_PRINCIPALE: None,
        TRANSACTION_CLE_LANGUE_MULTILINGUE: False,
        TRANSACTION_CLE_LANGUES_ADDITIONNELLES: None,
    }
