...
class MessagesSample(BaseCallback):
    ...
    def backup_domaine_senseurpassifs(self):
        ...
        self.handler_backup_senseurspassifs.backup_horaire_domaine('backup_domaine_senseurpassifs', heure, nom_collection_mongo)
    ...
    def backup_domaine_grosfichiers(self):
        ...
        heure = heure - datetime.timedelta(hours=1)
        self.__logger.debug("Faire backup horaire de %s" % str(heure))
        self.handler_grosfichiers.backup_horaire_domaine('backup_domaine_grosfichiers', heure, nom_collection_mongo)
