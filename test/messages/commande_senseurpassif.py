...
class MessagesSample(BaseCallback):
    ...
    def commande_demander_transactions(self):
        commande = {}
        domaineAction = 'commande.senseurpassif.48c7c654-b896-4362-a5a1-9b2c7cfdf5c4.transmettreTransactions'
    ...
    def executer(self):
        self.commande_demander_transactions()
