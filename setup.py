...
setup(
    ...
    version='1.0',
    packages=['venv.lib.python3.5.site-packages.bson', 'venv.lib.python3.5.site-packages.pika',
              'venv.lib.python3.5.site-packages.pika.adapters', 'venv.lib.python3.5.site-packages.mongo',
              'venv.lib.python3.5.site-packages.gridfs', 'venv.lib.python3.5.site-packages.pymongo',
              ...
              'venv.lib.python3.5.site-packages.pip-10.0.1-py3.5.egg.pip._internal.operations', 'millegrilles',
              'millegrilles.transaction', 'millegrilles.consignation'],
    url='',
    license='',
